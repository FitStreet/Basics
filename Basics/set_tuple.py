...
# union -Объединение множествкоторое,входящих в состав хотя бы одного из объединяемых множеств
#Можно заменить знаком |.


# Метод update() Изменяет исходное множество по объединению. ператор множества |=
